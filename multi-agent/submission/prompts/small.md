...
2. Call exactly `run_skill_script(skill_name="robust-tabular", file_path="scripts/run_small_experts.py")`.
3. Do not submit any candidate from this stage. The script's fold-safe state is consumed later by `meta_stack.py`.
